...
## Data Understanding
Dataset yang digunakan dalam analisis kali ini adalah [*Fires from Space: Australia*](https://www.kaggle.com/datasets/carlosparadis/fires-from-space-australia-and-new-zeland) yang merupakan data kebakaran hutan yang diambil dari Satelit NASA MODISC6 dan VIIRS 375m pada tahun 2019 hingga 2020 yang terdokumentasi melalui platform [kaggle](kaggle.com). Dataset ini terdapat 2 file csv yang ditangkap dari kedua jenis satelit dan yang akan kita analisis pada proyek ini adalah data NASA MODIS C6 dengan nama `fire_archie_M6_96619.csv`. Lisensi dapat dilihat pada bagian referensi[^3][^4].

Informasi terkait dataset dapat dirangkum sebagai berikut:

 <p align="center">Tabel 1. Rangkuman Informasi Dataset</p>
  <table align="center">
    <thead>
      <tr>
        <th>Jenis</th>
    ...
    <tbody>
      <tr>
        <td>Sumber</td>
        <td><a href="https://www.kaggle.com/datasets/carlosparadis/fires-from-space-australia-and-new-zeland">Fires from Space: Australia</a></td>
      </tr>
      <tr>
        <td>Lisensi</td>
        <td>Other</td>
      ...
      <tr>
        <td>Jenis dan Ukuran Berkas</td>
        <td>CSV (8.72 KB)</td>
      </tr>
    </tbody>
  </table>

Pada berkas yang diunduh berisi 512 baris dan 
